...
- **Numeric and categorical data** - combine conditions on different
  types of variables and, where appropriate, use
  [`partition()`](https://beerda.github.io/nuggets/reference/partition.md)
  to construct meaningful predicates from numeric or factor variables.
- **Extensible pattern discovery** -
  [`dig()`](https://beerda.github.io/nuggets/reference/dig.md) provides
  a general mechanism for searching candidate conditions and evaluating
  the resulting subsets of observations with arbitrary user-defined
  functions.

...
context("dig/SparseBitChain.h") {
    ...
    test_that("initialize by conjunction") {
        ...
        {
            SparseBitChain a1(10, PredicateType::BOTH, la);
            SparseBitChain a2(11, PredicateType::BOTH, la);
        ...
        {
            SparseBitChain a(10, PredicateType::BOTH, la);
            SparseBitChain b(20, PredicateType::CONDITION, lb);
            SparseBitChain c(a, b);
        ...
        {
            SparseBitChain a(10, PredicateType::BOTH, la);
            SparseBitChain b(20, PredicateType::FOCUS, lb);
            SparseBitChain c(a, b);
            expect_true(!c.isCondition());
            expect_true(c.isFocus());
            expect_true(!c.isCached());

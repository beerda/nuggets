...
See [Pre-defined Patterns](#pre-defined-patterns) below for examples and details.
...
See [Advanced Use](#advanced-use) for examples of custom pattern discovery.
...
disj_combined <- c(disj, rep(NA, 4))  # 4 new columns: mpg, disp, hp, wt
...
# Extend disjoint vector for the new numeric columns
disj_combined2 <- c(disj, rep(NA, 3))  # 3 new columns: mpg, hp, wt

...
- A predicate in the antecedent is removed if it can be deduced from the
  remaining antecedent predicates via the axioms (it is redundant).
...
deduced from their antecedent, and removes redundant predicates from antecedents.
...
6. **Excluding entailed rules** with the `excluded` argument and
   ...
   removes redundant antecedent predicates. This speeds up the search and

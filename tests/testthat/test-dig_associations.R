test_that("dig_associations without contingency table", {
    ...
    expect_equal(attr(res, "call_data")$data_nrow, 5)
    expect_equal(attr(res, "call_data")$data_ncol, 3)
    expect_equal(attr(res, "call_data")$data_colnames, c("a", "b", "c"))
...
test_that("compare dig_associations to arules::apriori", {
    ...
    expect_equal(attr(res, "call_function"), "dig_associations")
    expect_true(is.list(attr(res, "call_data")))
    expect_equal(attr(res, "call_data")$data_nrow, 100)
    expect_equal(attr(res, "call_data")$data_ncol, 5)
    expect_equal(attr(res, "call_data")$data_colnames, c("a", "b", "c", "d", "e"))
    expect_true(is.list(attr(res, "call_args")))

...
test_that("dig_baseline_contrasts t", {
    ...
    expect_setequal(res$support, c(1, 1, rep(0.5, 8), rep(0.25, 8)))
    expect_setequal(res$var, rep(c("conc", "uptake"), 9))
...
test_that("dig_baseline_contrasts call args", {
    ...
    expect_true(is_nugget(res, flavour = "baseline_contrasts"))
    expect_true(is_tibble(res))
    expect_equal(attr(res, "call_function"), "dig_baseline_contrasts")
